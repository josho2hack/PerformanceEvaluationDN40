...
namespace pes.Module {
    ...
    public class ImportDataLogic {
        ...
        public static ValidateDataDelegate<OwnScore> CreateDummOwnScoreValidateDataDelegate()
        {
            return delegate (OwnScore ownscore, object[] args) {
                if (ownscore != null)
                {
                    return ownscore.GetHashCode() % 2 == 0;
                }
                return false;
            };
        }
