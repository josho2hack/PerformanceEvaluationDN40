...
namespace pes.Web {
    ...
    public partial class pesAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private pes.Module.pesModule module3;
        private pes.Module.Web.pesAspNetModule module4;
        ...
        {
            //args.ObjectSpaceProvider = new XPObjectSpaceProvider(GetDataStoreProvider(args.ConnectionString, args.Connection), true);  //Original
            args.ObjectSpaceProvider = new SecuredObjectSpaceProvider((SecurityStrategyComplex)Security, args.ConnectionString, args.Connection); //List view hide Protection Content
            ...
            //args.ObjectSpaceProviders.Add(new NonPersistentObjectSpaceProvider(TypesInfo, null)); //Original
        ...
        private void pesAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new pes.Module.pesModule();
            this.module4 = new pes.Module.Web.pesAspNetModule();
            ...
            this.securityStrategyComplex1.UserType = typeof(pes.Module.BusinessObjects.Employee);
            // 
            // auditTrailModule
            // 
            ...
            // 
            // pesAspNetApplication
            // 
            this.ApplicationName = "pes";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.pesAspNetApplication_DatabaseVersionMismatch);
