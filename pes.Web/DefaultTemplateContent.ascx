<%@ Control Language="C#" CodeBehind="DefaultTemplateContent.ascx.cs" ClassName="DefaultTemplateContent" Inherits="pes.Web.DefaultTemplateContent"%>
<%@ Register Assembly="DevExpress.Web.v17.1, Version=17.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web"
    TagPrefix="dx" %>
